...
public class BlockOreSunstone extends BlockOre {

	public BlockOreSunstone(String n, String txt, int hardness, int mindam) {
	...
	public int getItemDrop(Player p, World w, int d, int x, int y, int z){
		...
		return Items.sunstone.itemID; //override this if you want to drop an item instead of a block.
	}
