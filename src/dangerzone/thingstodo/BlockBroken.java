...
public class BlockBroken extends ToDoItem {
	...
	//passthru...
	public BlockBroken(String uniname, String mytitle, String somehelp, int type, Block blocktype, int howmany) {
	...
	public void onBroken(Player pl, int d, int x, int y, int z, int bid){
